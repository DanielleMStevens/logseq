...
- **Results**:
	...
	- **CLas infection triggers immune response and cell death in the phloem tissues**
		...
		- We observed cell death of sieve element and companion cells via transmission electron
		  141 microscopy (TEM) analysis of asymptomatic young leaves of HLB positive C. sinensis ‘Valencia’
		  142 trees (Fig. 2A-D), indicating cell death of phloem tissues occurs prior to the appearance of HLB
		  143 symptoms. CLas was observed in phloem tissues with intact sieve element and companion cells,
		  144 but not in sieve element cells undergoing the cell death process (Fig. 2C-E).
- **Discussion**: